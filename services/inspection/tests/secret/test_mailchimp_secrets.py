...
def test_mailchimpaccesskey_detector_detects_expected_secrets(run_with_detector, secret: str, should_flag: bool):
    """
    ...
    finding: Finding | None = _get_finding(resp.findings, "secret_mailchimp_access_key")
